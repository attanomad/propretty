...
import { PropertyUpdateOneRequiredWithoutPropertyListingNestedInput } from '../property/property-update-one-required-without-property-listing-nested.input';
import { Type } from 'class-transformer';

@InputType()
export class PropertyListingUpdateInput {
    ...
    @Field(() => PropertyUpdateOneRequiredWithoutPropertyListingNestedInput, {nullable:true})
    @Type(() => PropertyUpdateOneRequiredWithoutPropertyListingNestedInput)
    property?: PropertyUpdateOneRequiredWithoutPropertyListingNestedInput;
}
