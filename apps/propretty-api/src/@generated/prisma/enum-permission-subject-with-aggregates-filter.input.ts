...
import { NestedEnumPermissionSubjectWithAggregatesFilter } from './nested-enum-permission-subject-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPermissionSubjectFilter } from './nested-enum-permission-subject-filter.input';

@InputType()
export class EnumPermissionSubjectWithAggregatesFilter {
