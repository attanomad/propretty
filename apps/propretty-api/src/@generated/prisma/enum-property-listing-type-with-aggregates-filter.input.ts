...
import { NestedEnumPropertyListingTypeWithAggregatesFilter } from './nested-enum-property-listing-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPropertyListingTypeFilter } from './nested-enum-property-listing-type-filter.input';

@InputType()
export class EnumPropertyListingTypeWithAggregatesFilter {
