...
import { NestedEnumPropertyMaintenanceRequestStatusWithAggregatesFilter } from './nested-enum-property-maintenance-request-status-with-aggregates-filter.input';
...
@InputType()
export class EnumPropertyMaintenanceRequestStatusWithAggregatesFilter {
