...
import { NestedEnumLeaseStatusWithAggregatesFilter } from './nested-enum-lease-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumLeaseStatusFilter } from './nested-enum-lease-status-filter.input';

@InputType()
export class EnumLeaseStatusWithAggregatesFilter {
