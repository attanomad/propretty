...
import { NestedEnumPropertyFurnishingNullableWithAggregatesFilter } from './nested-enum-property-furnishing-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumPropertyFurnishingNullableWithAggregatesFilter {
